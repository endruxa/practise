...
@section('content')
    ...
    <div class="container">
        ...
        @endcomponent
        <hr>
        <a href="{{route('admin.users.user.create')}}" class="btn btn-primary pull-right"><i class="fa fa-plus-square-o" aria-hidden="true"></i>  Создать пользователя</a>
        <table class="table table-striped">
            ...
            @forelse($users as $user)
                ...
                $user)}}" method="post">
                            ...
                            <a class="btn btn-default" href="{{route('admin.users.user.edit', $user)}}"><i class="fa fa-edit" aria-hidden="true"></i></a>
